...
{
    public partial class StaStd : System.Web.UI.Page
    {
            ...
            private void RefreshData()
            {
                ...
                {
                    gvw_StudentData.DataSource = Global.Students.Data;
                    gvw_StudentData.DataBind();
            ...
            {
                StdReg.Action = InputModes.UPDATE;
                StdReg.IDTarget = txt_ID.Text;
